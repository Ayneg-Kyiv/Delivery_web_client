    ...
    return (
        <div className="flex flex-col w-full min-h-screen bg-darker rounded-lg">
            ...
            <div className="flex-1 flex flex-col gap-6 px-6 pb-10">
                {loading ? (
                    <div className="text-white text-center py-20">{t.profile.myReviews.loading}</div>
                ) : reviews.length === 0 ? (
                    ...
                    reviews.map(review => (
                        <div key={review.id} className="bg-[#2d1857] rounded-xl flex flex-row items-center p-6 shadow-lg">
                            <Image
                                ...
                                alt={review.reviewer?.userName || t.profile.myReviews.reviewer}
                                width={80}
                                height={80}
                            ...
                            <div className="flex-1 flex flex-col px-6">
                                ...
                                <div className="flex flex-col gap-2 mt-4">
                                    <div className="text-white font-bold">{t.profile.myReviews.rating}: <span className="text-yellow-400">{review.rating}</span></div>
