            ...
            <div className="flex flex-col w-full min-h-screen bg-[#1a093a]">
                <div className="relative w-full h-[400px]">
                    ...
                    <div className="absolute inset-0 bg-[#1a093a]/60 flex flex-col justify-center items-center">
                        <h1 className="text-4xl font-bold mb-4">Знайдіть запит на доставку</h1>
                        ...
                        <div className='mt-6 flex flex-row items-center justify-center'>
                            ...
                            </button>
                            {
                                ...
                                (
                                    <Link href={'/delivery/request/add'} className="ml-6 bg-white button-type-1 py-4 w-[252px] rounded-lg font-bold flex items-center justify-center">
                                        Створити запит
                                    </Link>
                                )
                            }
                    ...
                    <div className="flex-1 flex flex-col gap-6">
                        {loading ? (
                            ...
                            requests.map(request => (
                                <div key={request.id} className="bg-[#2d1857] rounded-xl flex flex-row items-center p-6 shadow-lg">
                                    ...
                                    <div className="flex flex-col items-end gap-2">
                                        ...
                                        {this.props.session.status === 'authenticated' && this.props.session.data.user.roles.includes('User') && (
                                            <Link href={`/delivery/request/${request.id}`}>
                                                <button className="bg-white text-[#7c3aed] px-6 py-2 rounded-lg font-bold mt-2">Деталі</button>
                                            </Link>
                                        )}
                                    </div>
                                </div>
